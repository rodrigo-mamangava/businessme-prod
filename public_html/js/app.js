var myApp = angular.module('myApp',
        ['ngRoute', 'firebase', 'ngMaterial', 'ngDraggable', 'angular-toArrayFilter',
            'angularMoment', 'angular-flippy', 'angulartics', 'angulartics.google.analytics'])
        .constant(
...
myApp.config(['$routeProvider', function ($routeProvider) {
        $routeProvider
                ...
                //assine
                .when('/assine', {
                    templateUrl: 'js/assinatura/view/assine.html',
